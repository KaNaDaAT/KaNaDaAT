...
Having graduated from an IT school in Vienna in 2021, I found my passion for C# among the array of tools and languages I encountered. In October 2021, I transitioned into an information technology bachelor's program, which I completed in February 2024. Now, I'm continuing my master's journey since March 2024, currently already in my 4th semester and working on my master’s thesis as part of the [Vienna WebGPU Engine](https://github.com/hlavacs/Vienna-WebGPU-Engine) Project — a C++ render engine built with WebGPU, focused on learning, clean architecture, and real-time rendering. 

Professionally, I'm knee-deep in the .NET world, working on cool projects. On the side, I'm still doing my game development thing or working on my own engine and smaller projects because, well, it's just too much fun to give up!
